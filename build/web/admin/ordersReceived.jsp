        ...
        <table id="customers">
            ...
            <%
                ...
                try {
                    ...
                    ResultSet rs = st.executeQuery("select *from cart_jsp inner join product_jsp where cart_jsp.product_id=product_jsp.id and cart_jsp.orderDate is not NULL and cart_jsp.status='processing'");
                    while (rs.next()) {
            ...
            <tr>
                ...
                <td><a href="deliverOrderAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Delivered <i class='fas fa-dolly'></i></i></a></td>
            </tr>
            <%           }
                } catch (Exception e) {
                    e.printStackTrace();
